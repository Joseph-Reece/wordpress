    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first mt-2">
                ...
                <img style="margin-left:-20px;" width="120" src="/dashboard/admin/assets/img/<?php echo $settings['logo'];?>"/>
                <hr>
            </div>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
				...
				<div class="form-group ml-4 mr-4 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
